...
func (c *authService) MakeAccessToken(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "AuthService.MakeAccessToken", in)
	out := new(Response)
...
func (c *authService) DelUserAccessToken(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "AuthService.DelUserAccessToken", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (h *authServiceHandler) MakeAccessToken(ctx context.Context, in *Request, out *Response) error {
	return h.AuthServiceHandler.MakeAccessToken(ctx, in, out)
}

func (h *authServiceHandler) DelUserAccessToken(ctx context.Context, in *Request, out *Response) error {
	return h.AuthServiceHandler.DelUserAccessToken(ctx, in, out)
}
